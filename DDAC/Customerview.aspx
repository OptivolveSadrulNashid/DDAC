...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="shipping_id" DataSourceID="SqlDataSource1">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ddacassignmentConnectionString %>" SelectCommand="SELECT [shipping_id], [departure_port], [arrival_port], [shipping_date], [shipping_status], [shipping_cost], [shipping_details] FROM [Shipping] WHERE user_name='talal'"></asp:SqlDataSource>
    </div>
